...
import fr.univrouen.umlreverse.model.diagram.sequence.visitor.ExportPlantUMLSequenceVisitor;
    ...
    public void showAndWait() {
        ...
        if (diagram != null && file != null && b.get()) {
            if (diagram.getClass() == ClassDiagram.class) {
                ...
                ExportPlantUMLSequenceVisitor visitor = new ExportPlantUMLSequenceVisitor(file);
                ...
                ExportPlantUMLPackageVisitor visitor = new ExportPlantUMLPackageVisitor(file);
        ...
        choiceFile.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                fileChooser.getExtensionFilters().add(
                    new FileChooser.ExtensionFilter("PlantUML files (*puml)", "*.puml"));
                file = fileChooser.showSaveDialog(window);
                if (file != null) {
                    if (!file.getAbsolutePath().matches(".*.puml")) {
                        File newFile = new File(file.getAbsolutePath()+ ".puml");
                        file = newFile;
                    }
