...
// ATTRIBUTES
     ...
     */
    public DialogRelation(IRelation relation) {
    ...
    private void createDialog() {
    	List<RelationTypeEnum> typeset =
    			(relation.getEntitySource() instanceof INoteUsecase ||
    			relation.getEntityTarget() instanceof INoteUsecase)
    				? Collections.singletonList(RelationTypeEnum.ASSOCIATION)
    				: RelationTypeEnum.getUsecaseTypes();
        types = new ComboBox<>();
