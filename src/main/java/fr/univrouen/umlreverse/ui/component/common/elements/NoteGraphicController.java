...
public class NoteGraphicController extends AEntityGraphicController implements IEntityTextGraphicController {


	// ATTRIBUTES
    private final NoteGraphic noteG;
    // modelNote is the representation of a note in the model **
    private final INote modelNote;
    //private final Map<IViewEntity, NoteRelationGraphic> relations;
    private final IDiagramEditorController diagramController;
    
    // CONSTRUCTORS
    public NoteGraphicController(NoteGraphic noteG, 
    		IDiagramEditorController diagramController, INote note) {
        super();
